...
void add_sphere( struct matrix * edges, 
  ...
  for ( lat = latStart; lat < latStop; lat++ ) {
    for ( longt = longStart; longt < longStop; longt++ ) {
      ...
      index1 = (lat + 1) % latStop * step + longt;
      ...
      add_polygon( edges, points->m[0][index1 + 1],
		   points->m[1][index1 + 1],
		   points->m[2][index1 + 1],
		   points->m[0][index1],
		   points->m[1][index1],
  ...
  for ( lat = latStart; lat < latStop; lat++ ) {
    for ( longt = longStart; longt < longStop; longt++ ) {
      ...
      add_polygon( edges, points->m[0][index],
		   ...
		   points->m[1][index1],
		   points->m[2][index1]);
      add_polygon( edges, points->m[0][(index1 + 1) % points->lastcol],
		   points->m[1][(index1 + 1) % points->lastcol],
		   points->m[2][(index1 + 1) % points->lastcol],
		   points->m[0][index1],
		   points->m[1][index1],
		   points->m[2][index1],
		   points->m[0][(index + 1) % points->lastcol],
